...
function estimatePrepTime(arrIngredients, prepTimeMin) {
  if (prepTimeMin === 0 || prepTimeMin === undefined) {
    return arrIngredients.length * 2
  }
  return arrIngredients.length * prepTimeMin
}
