...
function estimatePrepTime(ingredients, timePer){
  let timePrep
  if(timePer === undefined) timePrep = 2
  else timePrep = timePer

  return ingredients.length * timePrep
}
...
function calculateQuantities(ingredients, layers){
  let obj = {sugar: 0, eggs: 0}
  if (ingredients.includes("sugar")) obj.sugar = 100 * layers
  if (ingredients.includes("eggs")) obj.eggs = 2 * layers
...
function improveRecipe(ingredients, portions)
{
  ...
  let obj = ingredients
  if (Object.hasOwn(obj, "eggs")) obj.eggs = obj.eggs * portions
  if (Object.hasOwn(obj, "milk")) obj.milk = obj.milk * portions
  if (Object.hasOwn(obj, "sugar")) obj.sugar = obj.sugar * portions
  if (Object.hasOwn(obj, "flour")) obj.flour = obj.flour * portions
