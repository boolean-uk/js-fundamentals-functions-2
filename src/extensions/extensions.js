...
function estimatePrepTime(arr, prepTime = 2) {
  const totalPrepTime = arr.length * prepTime;
...
function improveRecipe(obj, portions) {
  ...
  for (const ingredient in obj) {
    improvedRecipe[ingredient] = obj[ingredient] * portions
  }
  return improvedRecipe
}

console.log(improveRecipe({ sugar: 100, eggs: 3, flour: 200}, 3))
