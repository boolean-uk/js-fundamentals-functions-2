...
function estimatePrepTime(arr, minPerIncr = 2) {
  return arr.length * minPerIncr
}
// console.log(estimatePrepTime(['sugar', 'milk', 'flour', 'eggs'],5))
...
function calculateQuantities(incredients, layers) {
  ...
  if (incredients.includes('sugar')) {
    quantities.sugar = layers * 100
  } else {
    quantities.sugar = 0
  }
  if (incredients.includes('eggs')) {
...
// console.log(calculateQuantities(['milk', 'sugar', 'eggs'], 12))
...
function improveRecipe(obj, persons) {
