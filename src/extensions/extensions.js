...
let ingredients= ['sugar', 'milk', 'flour', 'eggs']

function estimatePrepTime(numIngredients, time) {
  if (time > 0) {
   const prep= numIngredients * time
   return prep
} else {
   const prep2= ingredients.length * 2
   return prep2
}
}

//console.log(estimatePrepTime())
...
//if ingredients.includes(['sugar', 'eggs'])
