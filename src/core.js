...
function remainingBakeTime(timeLeft){
  return bakingTime() - timeLeft
}
...
function totalTimeSpent(numberOfLayers, timeBakedInOven){
  const preparationTime = calculatePreparationTime(numberOfLayers)
  return preparationTime + timeBakedInOven
}
