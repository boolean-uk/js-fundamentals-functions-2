...
function remainingBakeTime(minutes) {
  return bakingTime() - parseInt(minutes)
}
...
function totalTimeSpent(nrLayers, nrMinutes) {
  return calculatePreparationTime(nrLayers) + nrMinutes
}
