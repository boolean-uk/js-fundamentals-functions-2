...
function remainingBakeTime(numMinutesPassed) {
  return bakingTime() - numMinutesPassed
}
...
function totalTimeSpent(numLayers, numMinutesPassed) {
  return calculatePreparationTime(numLayers) + numMinutesPassed
}
