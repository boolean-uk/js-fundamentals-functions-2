...
function remainingBakeTime(minutesElapsed){
  return bakingTime() - minutesElapsed
}
...
function totalTimeSpent(numLayers, minutesElapsed){
  return calculatePreparationTime(numLayers) + minutesElapsed
}
