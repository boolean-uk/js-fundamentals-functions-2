...
function remainingBakeTime (cookMinutes){
  //const bakeTime=50
return bakingTime()-cookMinutes
}
...
function totalTimeSpent(layers,cookMinutes) {
return cookMinutes+calculatePreparationTime(10)
}
