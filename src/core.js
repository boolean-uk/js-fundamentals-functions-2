...
function remainingBakeTime(currentMinutesInOven) {
const minutesLeft = bakingTime() - currentMinutesInOven
return minutesLeft 

}

console.log(remainingBakeTime(5))
...
const totalPrepTime = numberOfLayers * 3
...
function totalTimeSpent(numberOfLayers, numberOfMInsInOven) {
  const preparationTimes = calculatePreparationTime(numberOfLayers)
  //totalTime = preparationTime + numbersOfMinsInOven
  const totalTime = preparationTimes + numberOfMInsInOven
  return totalTime
}
