...
function remainingBakeTime(numberOfMinsInTheOven) {
  return bakingTime() - numberOfMinsInTheOven
}
...
function calculatePreparationTime(numberOfCakeLayers) {
  return numberOfCakeLayers * 3
}
...
function totalTimeSpent(numberOfCakeLayers, numberOfMinsInTheOven) {
  return calculatePreparationTime(numberOfCakeLayers) + numberOfMinsInTheOven
}
