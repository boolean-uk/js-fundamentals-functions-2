...
console.log(`BakingTime function, `, bakingTime())
...
function remainingBakeTime(currentCookTime) {
  return bakingTime() - currentCookTime
}

console.log(`remainingBakeTime function, `, remainingBakeTime(40))
...
console.log(`calculatePreparationTime, `, calculatePreparationTime(3))
...
function totalTimeSpent(cakeLayers, currentCookTime) {
  return calculatePreparationTime(cakeLayers) + currentCookTime
}

console.log(`totalTimeSpent, `, totalTimeSpent(5, 20))
