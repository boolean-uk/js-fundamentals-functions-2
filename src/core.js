...
const remainingBakeTime = (timeElapsed) => bakingTime() - timeElapsed
...
const calculatePreparationTime = (nbLayers) => nbLayers * 3
...
const totalTimeSpent = (nbLayers, timeElapsed) =>
  calculatePreparationTime(nbLayers) + timeElapsed
console.log(totalTimeSpent(10, 10))
