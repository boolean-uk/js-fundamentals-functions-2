...
const remainingBakeTime = (ovenTime) => {
...
const calculatePreparationTime = (layers) => {
  layers *= 3
  return layers
}
...
const totalTimeSpent = (layers, ovenTime) => {
  return calculatePreparationTime(layers) + ovenTime
}
