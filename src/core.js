...
const result1 = calculatePreparationTime(3)
console.log(result1)
...
function totalTimeSpent(numberLayers, bakingMinutes) {
  const preparationTime = calculatePreparationTime(numberLayers)
  const totalMinutes = preparationTime + bakingMinutes
  return totalMinutes
}

const cakeLayers = 3
const bakingMinutes = 40
const totalTime = totalTimeSpent(cakeLayers, bakingMinutes)
