...
function remainingBakeTime(minsInTheOven) {
  return bakingTime() - minsInTheOven
}
...
function totalTimeSpent(layersNum, minsInTheOven) {
  return calculatePreparationTime(layersNum) + minsInTheOven
}
