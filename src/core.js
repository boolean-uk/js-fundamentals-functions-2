...
function calculatePreparationTime(numberLayers) {
  return 3 * numberLayers
}
...
function totalTimeSpent(numberLayers, minutesInOven) {
  return calculatePreparationTime(numberLayers) + minutesInOven
}
