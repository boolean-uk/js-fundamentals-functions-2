...
function remainingBakeTime(minsBaked) {
  return bakingTime() - minsBaked
}
...
function totalTimeSpent(numLayers, minsBaked) {
  return calculatePreparationTime(numLayers) + minsBaked
}
