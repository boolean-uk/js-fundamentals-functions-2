...
function remainingBakeTime(minutesIn) {
  const time = bakingTime() - minutesIn
  return time
}
...
function totalTimeSpent(layer, minutesIn) {
  const time = calculatePreparationTime(layer) + minutesIn
  return time
}
