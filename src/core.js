...
function remainingBakeTime(totalMinutes) {
  return bakingTime() - totalMinutes
}
remainingBakeTime()
...
function totalTimeSpent(cakeLayers, minsInOven) {
  return calculatePreparationTime(`${cakeLayers}`) + minsInOven
}
totalTimeSpent()
