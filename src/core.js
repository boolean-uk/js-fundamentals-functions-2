...
function remainingBakeTime(cooktime) {
  const finalCookTime = bakingTime() - cooktime
  return finalCookTime
}
console.log('You have', remainingBakeTime(25), 'minutes remaining.')
...
console.log('Your cake will take', calculatePreparationTime(7), 'to prepare')
...
function totalTimeSpent(layers,cooktime) {
  const timePrep = calculatePreparationTime(layers) + cooktime
  return timePrep
}

console.log("You've been making this cake for", totalTimeSpent(5, 20), "minutes")
