...
function remainingBakeTime(minutes) {
  ...
  const timeLeft = totalBakeTime - minutes
  return timeLeft
}
const bakingMinutes = remainingBakeTime(20)
console.log(bakingMinutes)
...
function calculatePreparationTime(layers){
  ...
  const layerMin = cakeLayers * 3
  return layerMin
}
const bakeLayersTime = calculatePreparationTime(5)
console.log(bakeLayersTime)
...
const timePreparing = calculatePreparationTime(layers)
const total = timePreparing + bakingMinutes
return total
}

const minutesTotal= totalTimeSpent(5, 20)
