...
function remainingBakeTime(numOfMin){
  return bakingTime()- numOfMin
}
console.log(remainingBakeTime (15))
...
function calculatePreparationTime (numbOfLayers){
  return numbOfLayers * 3
}
...
function totalTimeSpent(numbOfLayers, numOfMin){
  return calculatePreparationTime(numbOfLayers)+ numOfMin 
}
console.log(totalTimeSpent(5,15))
