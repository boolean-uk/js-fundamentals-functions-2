...
function remainingBakeTime(minutes){
  let remainingMinutes = bakingTime() - minutes
...
function totalTimeSpent(layers, bakingTime){
  let timeSpent = calculatePreparationTime(layers) + bakingTime
  return timeSpent
}
