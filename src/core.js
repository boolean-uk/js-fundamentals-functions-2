...
function totalTimeSpent(numOfLayer, numOfMinutes){
  return calculatePreparationTime(numOfLayer) + (bakingTime() - remainingBakeTime(numOfMinutes))
}
console.log(totalTimeSpent(10, 20))
