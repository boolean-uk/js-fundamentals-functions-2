...
function remainingBakeTime(minuteInOven) {
  return bakingTime() - minuteInOven
}
...
function totalTimeSpent(numberOfLayer, minuteInOven) {
  return calculatePreparationTime(numberOfLayer) + minuteInOven
}
