...
function remainingBakeTime(minsInOven){
  ...
  return totalBakeTime - minsInOven
}
//
...
function calculatePreparationTime(layersOnCake){
  return layersOnCake * 3
}
...
function totalTimeSpent(layersOnCake, minsInOven) {
  const preparationTime = calculatePreparationTime(layersOnCake)
  return preparationTime + minsInOven
}
