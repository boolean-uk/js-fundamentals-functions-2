...
function remainingBakeTime(elapsed){
  return  bakingTime() - elapsed
}
...
const totalTimeSpent=(layers,elapsedOvenTime)=>{
  return calculatePreparationTime(layers)+elapsedOvenTime
}
