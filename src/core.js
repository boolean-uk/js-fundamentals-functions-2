...
function remainingBakeTime(numberOfMinutesPassed) {
  const remainingBakeTime = bakingTime() - numberOfMinutesPassed
...
function calculatePreparationTime(cakeLayers) {
  ...
  return cakeLayers * minutesPerLayer
}
...
function totalTimeSpent(cakeLayers, numberOfMinutesBaking) {
  const totalTimeSpent = calculatePreparationTime(cakeLayers)
  return totalTimeSpent + numberOfMinutesBaking
}
