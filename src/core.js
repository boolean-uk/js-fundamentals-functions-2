...
const layers = 2
const ovenTime = 30
const remainingTime = remainingBakeTime(ovenTime)
const totalSpentTime = totalTimeSpent(layers, ovenTime)

console.log(`Remaining bake time: ${remainingTime} minutes`)
console.log(`Total time spent making the cake: ${totalSpentTime} minutes`)
