...
const remainingBakeTime = (minutesInTheOven) => {
  return bakingTime()-minutesInTheOven;
}
...
const calculatePreparationTime = (numberOfLayers) => {
...
const totalTimeSpent = (layers, minutesInTheOven) => {
  let timeForLayers = calculatePreparationTime(layers)
  return timeForLayers+minutesInTheOven;
}
