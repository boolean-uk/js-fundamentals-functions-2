...
function remainingBakeTime(elapsedTime) {
  return Math.max(bakingTime() - elapsedTime, 0)
}
...
function totalTimeSpent(numLayers, elapsedBakingTime) {
  return calculatePreparationTime(numLayers) + elapsedBakingTime
}
