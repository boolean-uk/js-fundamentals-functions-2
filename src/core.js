...
function calculatePreparationTime(nrOfCakeLayers) {
  return 3 * nrOfCakeLayers
}
...
function totalTimeSpent(nrOfCakeLayers, minutesInOven) {
  return calculatePreparationTime(nrOfCakeLayers) + minutesInOven
}
