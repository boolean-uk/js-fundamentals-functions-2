...
function calculatePreparationTime(layers) {
  const totalTime = 3 * layers
  return totalTime
}
console.log(`This is the preparation time`, calculatePreparationTime(3))
...
function totalTimeSpent(layers, timePassed) {
  const timeSpent = calculatePreparationTime(layers) + timePassed
  return timeSpent
}
console.log(`This is the total time that you have spent`, totalTimeSpent(3, 30))
