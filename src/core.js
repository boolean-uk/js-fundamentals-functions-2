...
function remainingBakeTime (oneParameter){
  return bakingTime()-oneParameter
}
...
function calculatePreparationTime(layersOfCake){
  return  layersOfCake*3
}
...
function totalTimeSpent( numOfLayers,numOfMinutes){
  return calculatePreparationTime(numOfLayers) + numOfMinutes
}
