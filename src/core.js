...
function remainingBakeTime(timeSpent) {
  return bakingTime() - timeSpent
}
...
function totalTimeSpent(cakeLayers, timeSpent) {
  return calculatePreparationTime(cakeLayers) + timeSpent
}
