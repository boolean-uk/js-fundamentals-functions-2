...
function remainingBakeTime(minutes) {
  const totalTime = 50
  let minutesLeft = totalTime - minutes
  return minutesLeft
}
...
function calculatePreparationTime(layersNum){
  const preparationTime = layersNum * 3
...
function totalTimeSpent(layersNum , minutes){
const preparationTime = calculatePreparationTime(layersNum)
