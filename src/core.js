...
function remainingBakeTime(currentBakingTime) {
  const totalBakingTime = bakingTime()
  const bakingRemainingTime = totalBakingTime - currentBakingTime
  return bakingRemainingTime;
}
...
function totalTimeSpent(numbersOfLayers, bakingMinutes){

  const timePreparation = calculatePreparationTime(numbersOfLayers)

  const totalTime = timePreparation + bakingMinutes
