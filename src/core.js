...
function remainingBakeTime(minutesLeftInOven){
  let originalTime = bakingTime()
  return originalTime - (minutesLeftInOven);
}
...
function totalTimeSpent(layers,minutes){
  let timeMakingCake = calculatePreparationTime(layers)
  return timeMakingCake + minutes;
}
