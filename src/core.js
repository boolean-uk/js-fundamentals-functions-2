...
function remainingBakeTime(minutesPassed){
  return bakingTime()-minutesPassed>0?bakingTime()-minutesPassed:0
}
...
function totalTimeSpent(layers,minutesPassed){
return calculatePreparationTime(layers)+minutesPassed
}
