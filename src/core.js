...
function remainingBakeTime(minsInOven) {
  const bakingTime = 50;
  let remainingTime = bakingTime - minsInOven;
...
function calculatePreparationTime(numsOfLayers) {
  const prepTimelayer = 3;
  let prepTime = numsOfLayers * prepTimelayer;
return prepTime;
}

// console.log(calculatePreparationTime(10)); 
// console.log(calculatePreparationTime(6)); 
...
function totalTimeSpent(numsOfLayers, numOfMins) {
  let prepTime = calculatePreparationTime(numsOfLayers)
  let totalTime = prepTime + numOfMins
  return totalTime;
}

// console.log(totalTimeSpent(2, 30));
