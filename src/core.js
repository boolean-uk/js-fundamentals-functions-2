...
// step 2:Create a loop that will deducts minuntesleft from the baking time
// step 3:return minuntesleft after the loop has run.
// step 4:console.log(remainingBakeTime())

function remainingBakeTime(minutesleft) {
  return bakingTime() - minutesleft
}
// console.log('remainingBakeTime(30)', remainingBakeTime(30))
...
function calculatePreparationTime(layers) {
  const preparation = layers * 3
  return preparation
}
// console.log('calculatePreparationTime(4)', calculatePreparationTime(4))
...
function totalTimeSpent(layers, minutesAlready) {
  const totatlTime = calculatePreparationTime(layers) + minutesAlready
  return totatlTime
}
