...
function calculatePreparationTime(layerNum) {
  return 3 * layerNum
}
...
function totalTimeSpent(layerNum, ovenTime) {
  return calculatePreparationTime(layerNum) + ovenTime
}
